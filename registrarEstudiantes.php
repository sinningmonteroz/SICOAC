	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-graduation-cap zmdi-hc-fw"></i> Registro <small>Estudiantes</small></h1>
			</div>
			<p class="lead">Podemos administrar los datos de los estudiantes, así como también hacer las actualizaciones correspondientes de los mismos y su respectiva eliminación!</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
...
try {
  $stmt= $connection->prepare('SELECT * FROM usuarios where nivel_acceso = 1');
  $stmt->execute();
