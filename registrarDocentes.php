	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-account zmdi-hc-fw"></i> Registro <small>Docentes</small></h1>
			</div>
			<p class="lead">Podemos administrar los datos de los docentes, así como también hacer las actualizaciones correspondientes de los mismos y su respectiva eliminación!</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
					<ul class="nav nav-tabs" style="margin-bottom: 15px;">
					  	...
					  	<li><a href="#listDoc" data-toggle="tab">Lista</a></li>
					</ul>
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane fade active in" id="new">
								...
								<div class="row">
									<div class="col-xs-12 col-md-10 col-md-offset-1">
									    <form action="registros.php" method="post">
									    	<fieldset>Datos del Docente</fieldset>
											<input type="hidden" name="acceso" value="2">
					  	...
					  	<div class="tab-pane fade" id="listDoc">
