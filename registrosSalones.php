    ...
    <section class="full-box dashboard-contentPage">
        ...
        <div class="container-fluid">
            <div class="page-header">
              <h1 class="text-titles"><i class="zmdi zmdi-graduation-cap zmdi-hc-fw"></i> Registro <small>Salones</small></h1>
            </div>
            <p class="lead">Podemos administrar los salones, así como también hacer las actualizaciones correspondientes de los mismos y su respectiva eliminación!</p>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12">
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-xs-12 col-md-10 col-md-offset-1">
                                        <form action="registrarSalon.php" method="post">
                                            <fieldset>Datos del salón</fieldset>
