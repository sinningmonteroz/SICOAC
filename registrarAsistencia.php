	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-graduation-cap zmdi-hc-fw"></i> Registrar <small>Asistencia</small></h1>
			</div>
			<p class="lead">Registro de la asistencia</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
					<ul class="nav nav-tabs" style="margin-bottom: 15px;">
					  	...
					  	<li><a href="#listEst" data-toggle="tab">Reporte de asistencia</a></li>
					</ul>
							...
							<div class="container-fluid">
								<div class="row">
									<div class="col-xs-12 col-md-10 col-md-offset-1">
									    <form action="asistenciaRegistrada.php" method="post">
...
?>
					...
					<a href="reporte.php">Reporte de asistencias</a>
					</div>
				</div>
			</div>
		</div>
